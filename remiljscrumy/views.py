...
def filtered_users(project_id):
    ...
    # scrumuser = ScrumUser.objects.get(user=request.user)
...
class ScrumGoalViewSet(viewsets.ModelViewSet):
    ...
    def create(self,request):
            ...
            user_id = request.user.scrumuser
            ...
            author = ScrumProjectRole.objects.get(user=user_id)
            ...
            scrum_project.save()
            goal = ScrumyGoals(user=author, goal_name=name_goal,goal_status=goal_status_start,
                goal_project_id=scrum_project.project_count,project_id=request.data['project_id'], moveable = True)
            goal.save()
    ...
    def patch(self, request):
            ...
            scrum_project_b = scrum_project.scrumygoals_set.get(id=request.data['goal_id']).user
    ...
    def put(self, request):
            ...
            if request.data['mode'] == 0:
                ...
                goal = scrum_project.scrumygoals_set.get(id=from_id)
                if goal.moveable == True:
                    ...
                    return JsonResponse({'message': 'Permission Denied: Period Elapsed!!!', 'data': filtered_users(request.data['project_id'])})
                ...
                goal = scrum_project.scrumygoals_set.get(id=request.data['goal_id'])
                if goal.moveable == True:            
        ...
        #         return JsonResponse({'exit':0, 'message':'Permission Denied: Reassignment of Goal', 'data':filtered_users(request.data['project_id'])})
        ...
        #         return JsonResponse({'exit':0, 'message':'Permission Denied: Unauthorized Name Change of Goal', 'data':filtered_users(request.data['project_id'])})
